<?php 
    ...
    function buscarPorId($id) {
        $query = "SELECT * FROM frases WHERE id_Frase LIKE ".$id.";";
        $database = new Database();
    ...
    /**
     * Recibe el titulo de una frase y busca por el en la base de datos 
     * @param string $titulo
     * @return Result Object
     */
    function buscarPorTitulo($titulo) {
        $query = "SELECT * FROM frases WHERE titulo LIKE '".$titulo."';";
        $database = new Database();
        $resultado = $database->getConn()->query($query);
    ...
    function buscarPorAmbos($id, $titulo) {
        $query = "SELECT * FROM frases WHERE id_Frase LIKE ".$id." AND titulo LIKE '".$titulo."';";
        $database = new Database();
        $resultado = $database->getConn()->query($query);
